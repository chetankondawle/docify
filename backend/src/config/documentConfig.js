...
const documentTypeConfig = {
  ...
  SALARY_SLIP: {
    ...
    fields: {
      employeeName: {
        label: 'Employee Name',
        aliases: ['employee_name', 'name', 'employee', 'employee_full_name', 'employeename', 'employee name', 'name of employee', 'staff name'],
        type: 'text',
        matchWith: ['username'],
        matchStrategy: 'substring',
        priority: 'high',
      ...
      employeeId: {
        label: 'Employee ID',
        aliases: ['employee_id', 'emp_id', 'id', 'employeeid', 'employee code', 'emp code', 'staff id', 'employee number', 'emp_no'],
        type: 'text',
        priority: 'high',
      },
      monthYear: {
        label: 'Month & Year',
        aliases: ['month_year', 'month', 'year', 'monthyear', 'period', 'pay period', 'for the month', 'salary month', 'month of', 'salary period'],
        type: 'text',
        priority: 'medium',
      },
      basicSalary: {
        label: 'Basic Salary',
        aliases: ['basic_salary', 'salary', 'base', 'basicSalary', 'basic pay', 'basic', 'basic wages'],
        type: 'number',
        priority: 'medium',
      },
      employeePanNumber: {
      ...
      deductions: {
        label: 'Deductions',
        aliases: ['deductions', 'deduction', 'pf', 'provident fund', 'tax', 'tds', 'insurance', 'other deductions', 'total deductions'],
        type: 'number',
        priority: 'low',
      },
      netSalary: {
